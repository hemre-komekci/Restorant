            ...
            <section className="row text-secondary my-3">
                <div className="col-md-4">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="E-posta" defaultValue={auth.user.email}
                    ...
                    <div className="form-group">
                        ...
                        <input type="password" name="password" value={password} className="form-control"
                            placeholder="Yeni Parola" onChange={handleChange} />
                    </div>

                    <div className="form-group">
                        <label htmlFor="cf_password">Yeni Şifer Tekrar</label>
                        <input type="password" name="cf_password" value={cf_password} className="form-control"
                            placeholder="Yeni Şifer Tekrar" onChange={handleChange} />
                    </div>
                ...
                <div className="col-md-8">
                    <h3 className="text-uppercase">Siparişler</h3>
                        ...
                        <table className="table-bordered table-hover w-100 text-uppercase"
                            ...
                            <thead className="bg-light font-weight-bold">
                                <tr>
                                    ...
                                    <td className="p-2">Teslim Edilmiş</td>
                                    <td className="p-2">Paralı</td>
                                </tr>
                            </thead>
